...
1. Scan local corpus assets automatically:
   - `~/.claude/projects/-Users-USER/*.jsonl` — CC transcripts (count files, estimate volume)
   - `~/.claude/projects/-Users-USER/memory/writing-persona.md` — existing personality profile
   - `~/.claude/projects/-Users-USER/memory/material-goldmine.md` — curated quotes
